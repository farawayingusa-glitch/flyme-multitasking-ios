...
Require-Text $KeyboardSource 'FLMContentExternalScale = 0.77'
...
Require-Text $Source 'FLMVirtualViewportScale = 0.77'
Require-Text $Source 'FLMVirtualViewportHeight = 675.3246753246753'
...
Write-Output 'scene lifecycle, 390x675.324675 logical viewport at 0.77 to 300.3x520, generic keyboard route, and serialized close verified'
