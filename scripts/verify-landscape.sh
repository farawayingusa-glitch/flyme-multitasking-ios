...
require_literal "$landscape" "BOOL usesEqualArc ="
require_literal "$landscape" "safeCenters=%@"
reject_literal "$landscape" "center.x = MAX(minimumX"
...
require_literal "$landscape" "FLMCopyPreference(@\"landscapeCardExpansion\")"
require_literal "$landscape" "self.landscapeCardExpansion / 100.0"
require_literal "$landscape" "CGRectGetMinY(physical)"
...
require_literal "$landscape" "@interface FLMLandscapeKeyboardRootViewController"
require_literal "$landscape" "directSpansPhysicalWidth"
require_literal "$landscape" "self.keyboardMaximumVisibleHeight"
require_literal "$landscape" "keyboard-frame pending-hide"
require_literal "$landscape" "restoreKeyboardLayerHost"
