...
Require-Text $Source 'CGAffineTransformMakeScale(hostScale, hostScale)'
Require-Text $Source 'targetPhysicalCard={'
Require-Text $Source 'hostScale=%.6f contentScale=%.6f'
...
Require-Text $KeyboardSource 'BOOL shouldApply = FLMKeyboardTargetApplication &&'
