...
Require-Text $KeyboardSource 'FLMContentExternalScale = 1.0'
...
Require-Text $Source 'FLMVirtualViewportWidth = 300.3'
Require-Text $Source 'FLMVirtualViewportScale = 1.0'
Require-Text $Source 'FLMVirtualViewportHeight = 520.0'
...
Write-Output 'scene lifecycle, locked 300.3x520 content viewport, generic keyboard route, and serialized close verified'
