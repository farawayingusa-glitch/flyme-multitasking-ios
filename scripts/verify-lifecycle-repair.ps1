...
Require-Text $Source 'floatingSceneCardGeometryPending'
Require-Text $Source 'floatingSceneCardGeometryCommitted'
Require-Text $Source 'commitFloatingCardSceneGeometryForIdentifier:'
Require-Text $Source 'finishFloatingCardSceneGeometryCommitForIdentifier:'
Require-Text $Source 'scene-card commit-request'
Require-Text $Source 'scene-card committed'
Require-Text $Source 'card-commit-fallback'
Require-Text $Source 'cardCommitted=%d'
