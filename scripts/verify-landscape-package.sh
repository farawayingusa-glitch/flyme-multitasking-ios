...
grep -q "Version: 0.1.1" "$workspace/control/control"
...
preferences_bundle="$workspace/root/var/jb/Library/PreferenceBundles/FlymeLandscapePrefs.bundle/FlymeLandscapePrefs"
test -f "$settings_entry"
test -f "$preferences_bundle"
grep -q "FlymeLandscapePrefs" "$settings_entry"
